  ...
  return (
    <div className="form-wrapper" id="feedback">
      ...
      <form className="form" onSubmit={handleSubmit}>
        <div className='d-md-flex flex-col justify-content-between gap-3'>
          {/* Name Field */}
        ...
        {/* Image Upload Field */}
        <div className="Input-Container-Image gap-3">
          ...
          {imagePreview && (
            <div className="image-preview">
              <img src={imagePreview} alt="Selected" className='Image-preview-img' />
            </div>
          )}
        </div>
        <div className='d-flex gap-3'>

          <button type="button" className="btn btn-toggle-map submit-button" onClick={() => { handleShow(); HandleLocationClick(); }}>
            Change Location
          </button>
